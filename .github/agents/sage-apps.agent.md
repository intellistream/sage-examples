---
name: sage-examples
description: Agent for SAGE examples/tutorials/apps with runnable minimal changes.
argument-hint: Include target folder (`examples`, `tutorials`, or `sage-apps`), goal, and run command.
...
2. Implement minimal local change.
3. Run relevant example/test and update nearby docs if behavior changed.
